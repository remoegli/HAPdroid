...
#include <jni.h>
/* Header for class ch_hsr_hapdroid_service_HAPvizLibrary */

#ifndef _Included_ch_hsr_hapdroid_service_HAPvizLibrary
#define _Included_ch_hsr_hapdroid_service_HAPvizLibrary
#ifdef __cplusplus
extern "C" {
#endif
/*
